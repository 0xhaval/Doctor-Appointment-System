    ...
    <div class="ibox-content">
        <form action="{{ route('admin.user.update', Auth::user()->id) }}" method="POST">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-10">
                    <input type="text" placeholder="Name" class="form-control" value="{{ $user->name }}" name="name">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-10">
                    <input type="email" placeholder="Email" class="form-control" value="{{ $user->email }}" name="email">
                </div>
            </div>
