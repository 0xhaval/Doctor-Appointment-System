...
<div class="ibox">
    ...
    <div class="ibox-content">
        <form id="form" action="{{ route('admin.patient.update', $patient->id) }}" method="POST" class="wizard-big">
            @csrf
            @method('PUT')
            @if ($errors->any())
            ...
            <fieldset>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label>Note</label>
                            <textarea class="form-control" name="note" id="note" cols="30" rows="5">{{ $patient->note }}</textarea>
                        </div>
                    </div>
                </div>
